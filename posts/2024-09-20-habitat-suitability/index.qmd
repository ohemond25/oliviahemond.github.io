...
description: "Visualizing changes in habitat suitability for African lions (Panthera leo) under different climate change scenarios"
author: "Olivia Hemond & Sam Lance"
date: 09-20-2024
image: maps.jpg
draft: false
categories: [GIS, Conservation, Climate, Modeling]
format: 
  html: 
    code-fold: true 
