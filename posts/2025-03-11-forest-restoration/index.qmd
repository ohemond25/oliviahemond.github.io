...
draft: false
categories: [R, Visualization, Restoration, Conservation]
format: 
  html: 
    code-fold: true 
...
In this project, I essentially wanted to answer the questions: 
...
[![Infographic showing the benefits and relative strengths of different forest restoration practices. Click on the image to zoom in and explore!](infographic.jpg){fig-align="center" width="8.5in"}](infographic.pdf)
